...
class productBase {
 ...
 ////////////////////
    ...
    fun test() {
        ...
        vegetablesRef.child("Fruits").child("product210").setValue(ProductTest(210,"Бананы 100г", 15,
        ...
        vegetablesRef.child("Fruits").child("product211").setValue(ProductTest(211,"Яблоки Голден 100г", 15,
        ...
        vegetablesRef.child("Fruits").child("product212").setValue(ProductTest(212,"Яблоки красные 100г", 18,
        ...
        vegetablesRef.child("Fruits").child("product216").setValue(ProductTest(216,"Виноград Киш-миш 100г", 15,
        ...
        vegetablesRef.child("Fruits").child("product217").setValue(ProductTest(217,"Виноград красный 100г", 25,
        ...
        vegetablesRef.child("Greens").child("product220").setValue(ProductTest(220,"Укроп", 50,
        ...
        vegetablesRef.child("Greens").child("product221").setValue(ProductTest(221,"Лук 100г", 70,
        ...
        vegetablesRef.child("Greens").child("product222").setValue(ProductTest(222,"Салат", 80,
        ...
        vegetablesRef.child("Mushrooms").child("product230").setValue(ProductTest(230,"Шапминьоны 250г", 100,
        ...
        vegetablesRef.child("Mushrooms").child("product301").setValue(ProductTest(301,"Шапминьоны 250г", 100,
            "https://firebasestorage.googleapis.com/v0/b/delivery-bf3b3.appspot.com/o/images%2Fvegetables%2Fphoto_2023-05-24_00-38-44.jpg?alt=media&token=cd64542e-d915-43b0-bc1b-63a43316f99c"))
/*
