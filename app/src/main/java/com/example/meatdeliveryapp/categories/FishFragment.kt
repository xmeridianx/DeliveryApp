...
import com.example.meatdeliveryapp.databinding.FragmentFishBinding
...
class FishFragment : Fragment(), OnProductClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productRefs = arrayOf(
            categoryRef.child("Fish").child("Fish"),
            categoryRef.child("Fish").child("canned") ,
            categoryRef.child("Fish").child("fish_snacks"))
