...
class SnacksFragment : Fragment(), OnProductClickListener {
    ...
    override fun onCreateView(
        ...
        binding = FragmentSnacksBinding.inflate(layoutInflater)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productRefs = arrayOf(
            categoryRef.child("Snacks").child("chips"),
            categoryRef.child("Snacks").child("nuts") ,
            categoryRef.child("Snacks").child("crackers"))
