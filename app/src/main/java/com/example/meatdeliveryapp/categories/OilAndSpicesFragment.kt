...
import com.example.meatdeliveryapp.databinding.FragmentOilAndSpicesBinding
...
class OilAndSpicesFragment : Fragment(), OnProductClickListener {
    private lateinit var binding: FragmentOilAndSpicesBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOilAndSpicesBinding.inflate(layoutInflater)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productRefs = arrayOf(
            categoryRef.child("Oil_spices").child("seasonings"),
            categoryRef.child("Oil_spices").child("oil") ,
            categoryRef.child("Oil_spices").child("ketchup"))
