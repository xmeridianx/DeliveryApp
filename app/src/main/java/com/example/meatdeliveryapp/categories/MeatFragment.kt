...
class MeatFragment : Fragment(), OnProductClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productRefs = arrayOf(
            categoryRef.child("Meat").child("meat"),
            categoryRef.child("Meat").child("sausages") ,
            categoryRef.child("Meat").child("forcemeat"))
