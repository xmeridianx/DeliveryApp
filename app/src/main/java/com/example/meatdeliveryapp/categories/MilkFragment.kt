...
import com.example.meatdeliveryapp.databinding.FragmentGroceryBinding
import com.example.meatdeliveryapp.databinding.FragmentMilkBinding
...
class MilkFragment : Fragment(), OnProductClickListener {
    ...
    override fun onCreateView(
        ...
        binding = FragmentMilkBinding.inflate(layoutInflater)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapters = Array(4) { AdapterProduct(mutableListOf(), this) }
        productRefs = arrayOf(
            categoryRef.child("Milk_eggs").child("Milk"),
            categoryRef.child("Milk_eggs").child("Yoghurts") ,
            categoryRef.child("Milk_eggs").child("Butters"),
            categoryRef.child("Milk_eggs").child("Eggs"))

        thread = Array(4) { Thread() }
