...
class GroceryFragment : Fragment(), OnProductClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productRefs = arrayOf(
            categoryRef.child("Grocery").child("Groats"),
            categoryRef.child("Grocery").child("Pasta") ,
            categoryRef.child("Grocery").child("Breakfast"),
            categoryRef.child("Grocery").child("Fast"))
