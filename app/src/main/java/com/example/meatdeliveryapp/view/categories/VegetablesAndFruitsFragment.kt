...
class VegetablesAndFruitsFragment : Fragment(), OnProductClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productRefs = arrayOf(
            categoryRef.child("Vegetables_fruits").child("Vegetables"),
            categoryRef.child("Vegetables_fruits").child("Fruits") ,
            categoryRef.child("Vegetables_fruits").child("Greens"),
            categoryRef.child("Vegetables_fruits").child("Mushrooms"))
