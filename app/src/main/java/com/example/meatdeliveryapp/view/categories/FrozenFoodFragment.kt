...
import com.example.meatdeliveryapp.databinding.FragmentFrozenFoodBinding
...
class FrozenFoodFragment : Fragment(), OnProductClickListener {
    private lateinit var binding: FragmentFrozenFoodBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFrozenFoodBinding.inflate(layoutInflater)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productRefs = arrayOf(
            ...
            categoryRef.child("Frozen_food").child("icecreams")
        )
