...
import com.example.meatdeliveryapp.databinding.FragmentCoffeeAndTeaBinding
...
class CoffeeAndTeaFragment : Fragment() , OnProductClickListener {
    private lateinit var binding: FragmentCoffeeAndTeaBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCoffeeAndTeaBinding.inflate(layoutInflater)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productRefs = arrayOf(
            categoryRef.child("Coffee_tea").child("coffee"),
            categoryRef.child("Coffee_tea").child("tea") ,
            categoryRef.child("Coffee_tea").child("cocoa"))
